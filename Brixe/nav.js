...
const categories = {
    "growth": ["Bio Generator", "Caption Pro", "Grid Previewer", "Hashtag Stacker", "Insta Caption Crafter", "LinkedIn Authority Generator", "Pinterest Description Generator", "Podcast Blurb Generator","Retention Script Map" ,"Safe zone checker", "Script timer", "Thumbnail Previewer", "TikTok Hook Generator", "Tweet Thread Starter", "Video Script Intros", "Viral Hook Generator", "pfp glow ring"],
    ...
    "generators": ["SaaS Name Generator","E Boy Alias Gen","E Girl Alias Gen","Cosplay Stage Namer","Twitch Stream Namer", "Steam Group and Library Namer","Valorant Agent Nicknames Gen" ,"Call of Duty Regiment Gen","Smurf Name Generator","VR Chat Persona Gen" , "Onlyfans Name Gen","Substack Newsletter Namer","Minecraft Server Name Gen", "Roblox Group Namer" , "Kpop Stage Name Generator", "Twitch Team Namer","Side Hustle Handle","Vtuber Name Generator", "Clan name generator", "Fantasy name generator", "Gamer Name generator", "Aesthetic Username generator", "Pet Name generator", "podcast name generator", "discord server namer", "clothing brand namer", "alias & persona generator", "Finsta Generator",
        "Cyberpunk City Namer","DnD Tavern Namer","Starwars OC Namer","Supervillain Moniker Gen","Post Apocalyptic Faction Gen","Anime Attack Name Gen","Mythical Creature Namer","Spaceship Name Generator","Fleet and Armada Namer","Pirate Ship and Crew Gen","Magical School Namer","Kingdom Name Generator","Empire Name Generator","Gothic Victorian Name Gen","Sci Fi Planet Namer"
        ,"Agency Name Generator","Etsy Name Generator","Shopify Store Namer","App Name Generator","Consultancy Firm Namer","Real Estate Team Namer","Gym Name Generator","Cafe Name Generator","Bakery Brand Namer","Jewelry Brand Namer","Eco Friendly Brand Namer","Legal Firm Namer","Cryptocurrency Namer","LLM Startup Namer","Japanese Business Namer","Latin Root Brand Namer","French Shop Namer","Korean Skincare Namer","Italian Fashion Brand Namer","Furniture Brand Gen","Perfume Brand Namer","Hotel and Resort Namer"
        ,"House Name Generator","Car Nickname Gen","Plant Name Generator","Twin Baby Name Matcher","Gender Neutral Name Gen","Old Money Aesthetic Namer","Cottagecore Name Gen","Dark Academia Persona Namer","Yacht Namer","Farm and Homestead Namer","Cocktail or Drink Namer","Recipe Namer","Wifi Network Namer","Team Building Group Namer","Project Codename Generator"]
};
